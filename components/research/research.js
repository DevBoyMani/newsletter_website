...
//                                 <button
//                                     className="py-3 px-8 border border-[#0C3D3D] bg-white text-[#0C3D3D] sm:text-xl text-center lg:text-left  rounded-full hover:bg-[#46DE46] hover:text-black w-full lg:w-6/12"
//                                 >
                    ...
                    <div className="flex-[1.1] text-black">
                        <div>
                           <p className="text-sm bg-[#46DE46] p-3 mb-4 font-diatype-mono">
                            ...
                            <div className="flex justify-center lg:justify-start mt-6 lg:mt-10">
                                <button
                                    className="py-3 px-4 border border-[#0C3D3D] bg-white text-[#0C3D3D] sm:text-xl text-center lg:text-center rounded-full hover:bg-[#46DE46] hover:text-black w-full lg:w-fit"
                                >
                                    See Our Research Studies
                                </button>
                            </div>
