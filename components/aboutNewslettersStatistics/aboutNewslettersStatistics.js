            ...
            <div className="flex flex-col md:flex-row justify-start items-start py-10">
                ...
                <div className="w-full md:w-1/2">
                    <div className="pl-14">
                        ...
                        Newsletter <span className="text-[#B3B3B3]">emails</span><br />
                        <span className="text-[#B3B3B3]">average</span> 20–25% open<br />
                        rates <span className="text-[#B3B3B3]">across industries.</span>
                     </h4>
                    </div>
