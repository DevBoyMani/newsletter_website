            ...
            <div className="bg-[#FAFAFA] md:px-12">
                <div className="w-full h-full relative overflow-hidden py-10">
                    ...
                    <div className="absolute inset-0 flex flex-col items-start justify-start pt-20 md:px-16">
                        <h2 className="text-[74px] text-[#01261E] font-[400] z-10 w-[58%]  leading-[94%] font-[GT-Super-Ds-Trial]" style={{textShadow:" 0px 4px 4px rgba(31, 25, 25, 0.00)"}}>Step into a world <br/> of discovery</h2>
                        <p className="w-[35%] z-10 py-8 font-Manrope font-[400] leading-[130%] text-[20px] text-[#121212]">
