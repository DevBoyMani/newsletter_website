              ...
              >
                ...
                <div className="">
                  ...
                  <p className="text-[#121212] text-[16px] font-[400] leading-[141%] pt-2">
                    We are looking for a sharp, curious, and culturally tuned-in{" "}
                    <strong>Content Writer</strong> to join the team behind{" "}
                    <i>London Summary</i>, a growing newsletter that curates the
                    most interesting stories, people, and happenings across
                    London. You will be part writer, part editor, part
                    detective, crafting stories that make readers feel more
                    connected to the city every morning.
                  </p>
                </div>
                {/* 5 */}
                {/* <div className="pt-[30px]">
                ...
                <div className="pt-[30px]">
                  ...
                  <ul className="custom-list text-[#121212] text-[16px] font-[400] leading-[141%] pt-2">
                    <li>
                      Research, write, and edit concise, engaging stories on
                      London’s news, business, culture, and lifestyle
                    </li>
                    <li>
                      Curate and summarize complex topics into clear, witty, and
                      human language
                    </li>
                    <li>
                      Pitch new story ideas, features, and interview angles
                      relevant to London audiences
                    </li>
                    <li>
                      Collaborate with editors, designers, and growth teams to
                      refine tone, visuals, and reader experience
                    </li>
                    <li>
                      Stay on top of trends, emerging events, and voices shaping
                      the city
                    </li>
                    <li>
                      Write social captions and short form content to promote
                      newsletter editions across platforms
                    </li>
                  </ul>
                </div>
                {/* 8 */}
                <div className="pt-[30px]">
                  ...
                  <ul className="custom-list text-[#121212] text-[16px] font-[400] leading-[141%] pt-2">
                    <li>
                      Excellent command of written English, with a natural,
                      engaging tone
                    </li>
                    <li>
                      Curiosity about London, its people, politics, business,
                      culture, and quirks
                    </li>
                    <li>
                      Strong research and summarization skills; you can turn a
                      2000 word article into 2 sentences of gold
                    </li>
                    <li>
                    ...
                    <li>
                      Attention to detail, deadlines, and storytelling craft
                    </li>
                    <li>
                      Ability to balance speed with substance; we move fast, but
                      never sloppy
                    </li>
                    <li>
                    ...
                    <li>
                      Understanding of local London news outlets and cultural
                      scenes
                    </li>
                    <li>
                      Comfort working with content management and CMS platforms
                    </li>
                  </ul>
                </div>
                {/* 9 */}
                <div className="pt-[30px]">
                  ...
                  <ul className="custom-list text-[#121212] text-[16px] font-[400] leading-[141%] pt-2">
                    <li>
                      Be part of <i>London Summary’s</i> editorial core as it
                      grows into one of the city’s leading newsletters
                    </li>
                    <li>
                      Freedom to pitch stories and shape voice in a publication
                      read by London’s professionals and decision makers
                    </li>
                    <li>
                      Flexible hours, fully remote, and tight creative feedback
                      loops
                    </li>
                    <li>
                      A creative, ambitious environment that values craft,
                      taste, ideas, and humor
                    </li>
                  </ul>
                </div>
                {/* 10 */}
                ...
                <div className="pt-[30px]">
                  <div
                    id="assignment"
                    className="px-[25px] py-[30px] bg-[#DAEBE8] rounded-[10px]"
                  >
                    <p className="text-[#121212] text-[18px] font-[700] leading-[141%] pb-2">
                      Content Writer Assignment - London
                    </p>
                    {/* heading */}
                    <div>
                      <p className="text-[#121212] text-[16px] font-[700] leading-[141%] pt-2 pb-2">
                        Objective
                      </p>
                      <p className="text-[#121212] text-[16px] font-[400] leading-[141%] py-2">
                      ...
                      <p className="text-[#121212] text-[16px] font-[400] leading-[141%] py-2">
                        This task tests your ability to combine news judgment,
                        storytelling, and editorial tone - the three traits that
                        define our writers at House of Summary.
                      </p>
                    </div>
                    {/* heading */}
                    <div>
                      ...
                      <p className="text-[#121212] text-[16px] font-[400] leading-[141%] py-2">
                        Create a short piece for <strong>London Summary</strong>
                        , a daily newsletter that covers business, culture, city
                        life, and the people shaping London today.
                      </p>
                      <p className="text-[#121212] text-[16px] font-[400] leading-[141%] py-2">
                        Your goal is to show how you can write smart, concise,
                        and engaging content that informs and entertains readers
                    ...
                    <div>
                      <p className="text-[#121212] text-[16px] font-[700] leading-[141%] pt-2 pb-2">
                        Option 1: The City Story
                      </p>
                      <p className="text-[#121212] text-[16px] font-[400] leading-[141%] pt-2">
                        Write a short feature (250–350 words) about a trend,
                        company, or person shaping modern London.
                      </p>
                      <p className="text-[#121212] text-[16px] font-[400] leading-[141%] pt-2">
                        Examples include:
                      </p>
                      <ul className="custom-list text-[#121212] text-[16px] font-[400] leading-[141%] pt-2">
                        <li>The rise of members-only restaurants in Mayfair</li>
                        <li>
                          How Canary Wharf is reinventing itself for remote
                          workers
                        </li>
                        <li>London’s next creative wave in East End fashion</li>
                      </ul>
                      <p className="text-[#121212] text-[16px] font-[400] leading-[141%] pt-2">
                        Include:
                      </p>
                      <ul className="custom-list text-[#121212] text-[16px] font-[400] leading-[141%] pt-2">
                        <li>A headline that grabs attention</li>
                        <li>
                          One or two stats, facts, or quotes (real or sourced
                          from public data)
                        </li>
                        <li>A closing insight or takeaway</li>
                      </ul>
                    </div>
                    {/* heading */}
                    <div>
                      <p className="text-[#121212] text-[16px] font-[700] leading-[141%] pt-2 pb-2">
                        Option 2: The Local Insight
                      </p>
                      <p className="text-[#121212] text-[16px] font-[400] leading-[141%] pt-2">
                        Summarize a recent business or cultural story from a
                        trusted London publication such as the Financial Times,
                        Evening Standard, or Time Out London.
                      </p>
                      <p className="text-[#121212] text-[16px] font-[400] leading-[141%] pt-2">
                        Your summary (200–300 words) should:
                      </p>
                      <ul className="custom-list text-[#121212] text-[16px] font-[400] leading-[141%] pt-2">
                        <li>Capture the core facts and why it matters</li>
                        <li>Include your own short commentary or angle</li>
                        <li>
                          Be written in a style fit for a daily newsletter —
                      ...
                      <p className="text-[#121212] text-[16px] font-[400] leading-[141%] pt-2">
                        If the source article is “London house prices fall 3%
                        year-over-year,” your version might frame it as:
                      </p>
                      <p className="text-[#121212] text-[16px] font-[400] leading-[141%] pt-2">
                        “London’s housing market is cooling, but not evenly.
                        West End flats are holding firm while Zone 3 homes are
                        seeing the biggest dip.”
                      </p>
                    </div>
                    {/* heading */}
                    <div>
                      <p className="text-[#121212] text-[16px] font-[700] leading-[141%] pt-2 pb-2">
                        Option 3: The Reader Hook
                      </p>
                      <p className="text-[#121212] text-[16px] font-[700] leading-[141%] pt-2 pb-2">
                        Goal: Show your tone range and ability to write tight,
                        scroll-stopping copy.
                      </p>
                      <p className="text-[#121212] text-[16px] font-[400] leading-[141%] pt-2">
                        Write three sample newsletter headlines and blurbs (two
                        to three sentences each) that would fit in London
                        Summary’s “Quick Reads” section.
                      </p>
                      <p className="text-[#121212] text-[16px] font-[400] leading-[141%] pt-2">
                        Examples:
                      </p>
                      <p className="text-[#121212] text-[16px] font-[400] leading-[141%] pt-2">
                        <strong>The Billionaire Café Boom</strong>
                        <br /> London’s coffee culture is going couture, with
                        luxury cafes charging £15 for oat milk lattes and people
                        lining up anyway.
                      </p>
                      <p className="text-[#121212] text-[16px] font-[400] leading-[141%] pt-2">
                        <strong>Tech Meets Thames</strong>
                        <br /> Fintech founders are moving their HQs to South
                        Bank, blending riverside views with rising valuations.
                      </p>
                    </div>
                  </div>
                </div>
