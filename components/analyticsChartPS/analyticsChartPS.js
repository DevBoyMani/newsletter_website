...
export function AnalyticsChartPS() {
      ...
      <div className="hidden lg:block relative w-[98%] h-[467px] perspective-1000 ">
        ...
        >
              ...
              <div className="flex justify-between">
                ...
                <div className="">
                  <div className="flex space-x-2 pl-8 pr-4">
                    <a className="text-xs leading-[1.4] bg-[#ffffffc0] px-2 py-1 rounded-full">
                      Daily
                    </a>
                    <a className="text-xs leading-[1.4] bg-[#ffffffc0] px-2 py-1 rounded-full">
                      Weekly
                    </a>
                    <a className="text-xs leading-[1.4] text-white bg-[#1E1B39] px-2 py-1 rounded-full">
                      Annually
                    </a>
                  </div>
                </div>
          ...
          >
            ...
            <div>
              <p className="text-gray-600 text-center w-[578px] h-[185] py-8 text-xl">
                Nullam egestas, lorem eget placerat sodales, risus nunc
                condimentum nisl, nec euismod lorem lacus sed mi. Maecenas et
                quam semper, facilisis quam ac, pulvinar arcu. Aliquam feugiat
                lobortis ex vel finibus. Mauris sodales arcu eget odio placerat
                aliquam sed vitae justo.{" "}
              </p>
            </div>
          </Card>
        </div>
      ...
      <div className="block lg:hidden relative">
        ...
        >
          {!flipped ? (
            ...
            <Card
              style={{ backfaceVisibility: "hidden" }}
              className="w-[90%] h-[190px] rounded-[20px] bg-white flex flex-col mx-auto shadow-lg"
            >
                ...
                <div className="flex justify-between items-center">
                  <div className="flex space-x-2">
                    ...
                    <p className="text-[4px] flex items-center">
                      <span className="bg-[#46DE46] text-white rounded-full px-1">
                        &#8599;
                      </span>
                      <span className="ml-1 text-[#46DE46] font-bold">
                        1.3%
                      </span>
                      <span className="ml-1 text-[4px] text-gray-400 tracking-widest">
                        VS LAST YEAR
                      </span>
                    </p>
                  </div>
                  <div>
                    <div className="flex space-x-1">
                      <a className="text-[5px] bg-[#ffffffc0] px-2 py-1 rounded-full">
                        Daily
                      </a>
                      <a className="text-[5px] bg-[#ffffffc0] px-2 py-1 rounded-full">
                        Weekly
                      </a>
                      <a className="text-[5px] text-white bg-[#1E1B39] px-2 py-1 rounded-full">
                        Annually
                      </a>
                    </div>
                  </div>
            ...
            <Card
              ...
              className="w-[90%] h-[190px] rounded-[20px] bg-[#D2DCF4] flex flex-col justify-center items-center shadow-lg p-4 relative mx-auto"
            >
              {/* Close Button */}
              <button
                onClick={() => setFlipped(false)}
              ...
              <div className="text-center">
                <h4 className="text-[16px] font-[GT-Super-Txt-Trial] mb-2">
                  Line chart
                </h4>
