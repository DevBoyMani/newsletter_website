    ...
    <>
      ...
      <div className="block lg:hidden bg-[#01261E]">
        <div className=" md:px-16 pt-[50px] mx-auto ">
          ...
          <div className="relative group overflow-hidden px-[30px]">
            <div className="overflow-hidden">
              <div className="flex gap-6 pt-[60px] animate-scroll-cards">
                {[...feedbackData, ...feedbackData].map((item, index) => (
                  <div
                    key={index}
                    className="w-[317px] h-[241px] bg-[#FFFFFF0D] pl-[17px] pr-[21px] pt-[21px] pb-[31px] rounded-lg border border-[#FFFFFF33] shrink-0"
                  >
