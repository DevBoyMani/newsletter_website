...
export default function MovieSuggestionsAnalytics() {
  return (
    <>
      {/* desktop */}
      ...
      <div className="block lg:hidden">
        <div className="px-4">
          {/* Hero section */}
          <div className="relative h-[232px] flex flex-col justify-between rounded-[10px] pt-[16px] pl-[16px] bg-[url('/analytics/bg-ms.png')] bg-cover bg-center overflow-hidden">
            <div className="z-90 relative ">
              ...
              <p className="font-[500] text-[12px] pt-[12px] leading-[137%]">
                No more endless scrolling. Just sit
                <br /> back and press play!
              </p>
