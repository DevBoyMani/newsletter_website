...
export default function LongAndShortAnalytics() {
  return (
    <>
      {/* desktop */}
      <div className="lg:block hidden">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pt-[22px]">
          <div className="relative h-[465px] flex flex-col justify-between rounded-[22px] p-[40px] bg-[url('/analytics/bg-ls.png')] bg-cover bg-center overflow-hidden">
            <div className="z-10">
      ...
      <div className="block lg:hidden">
        <div className="px-4">
          {/* Hero section */}
          <div className="relative h-[232px] flex flex-col justify-between rounded-[10px] pt-[16px] pl-[16px] bg-[url('/analytics/bg-ls.png')] bg-cover bg-center overflow-hidden">
            <div className="z-90 relative ">
              ...
              <p className="font-[500] text-[12px] pt-[12px] leading-[137%]">
                Insider news for the world of
                <br /> finance. Markets in minutes.
              </p>
            ...
            <img
              src="/analytics/mobile-a-ls.png"
              alt="Phone preview"
              className="absolute top-[52px] right-2 bottom-0 w-[180px] object-contain "
            />
          </div>
